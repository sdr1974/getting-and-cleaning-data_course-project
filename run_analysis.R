...
activity_labels <- read_delim('./Project Data/UCI HAR Dataset/activity_labels.txt', " ", col_names = F) %>% pull(2)
...
write.table(data_means, file="human_activiy.txt", row.names = FALSE)
